...
public class RestClient {
    ...
    public static String executePost(String URLAddress,
            String param, String login, String password) throws MalformedURLException, UnsupportedEncodingException {
    ...
    public static String executePost(String URLAddress,
            ...
            List<NameValuePair> postParams, String login, String password) throws MalformedURLException {
        CredentialsProvider provider = new BasicCredentialsProvider();
        UsernamePasswordCredentials credentials
                = new UsernamePasswordCredentials(login, password);
        provider.setCredentials(AuthScope.ANY, credentials);
    ...
    public static String executeGet(String URLAddress, String login, String password) throws MalformedURLException {
    ...
    public String executeGet(String URLAddress,
            Map<String, String> headerParams, String login, String password) throws MalformedURLException {
        CredentialsProvider provider = new BasicCredentialsProvider();
        UsernamePasswordCredentials credentials
                = new UsernamePasswordCredentials(login, password);
        provider.setCredentials(AuthScope.ANY, credentials);
